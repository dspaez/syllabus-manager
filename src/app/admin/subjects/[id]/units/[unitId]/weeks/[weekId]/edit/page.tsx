    ...
    return (
        <div className="p-8 max-w-lg">
            ...
            <div className="flex items-center gap-2 mb-4 text-sm text-slate-400 dark:text-slate-500 flex-wrap">
                ...
                <span className="text-slate-300 dark:text-slate-700">/</span>
                <span className="text-slate-600 dark:text-slate-400">Editar semana</span>
            </div>

            <h1 className="text-2xl font-semibold text-slate-900 dark:text-slate-100 mb-6">Editar semana</h1>
